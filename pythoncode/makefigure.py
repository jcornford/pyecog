...
def lda_plot():
    ...
    size = 20
    alpha = 0.8
    ax1.scatter(s1[:,0], s1[:,1],s1[:,2], c = utils.mc['k'], edgecolor = 'k', s=size, linewidth=0.4, alpha=alpha, zorder = 2)
    ax1.scatter(s2[:,0], s2[:,1],s2[:,2], c = utils.mc['r'], edgecolor = 'k', s=size, linewidth=0.4, alpha=alpha,zorder = 2)
    ax1.scatter(s3[:,0], s3[:,1],s3[:,2], c = utils.mc['b'], edgecolor = 'k', s=size, linewidth=0.4, alpha=alpha,zorder = 2)
    ax1.scatter(bl[:,0], bl[:,1],bl[:,2], c = utils.mc['grey'], edgecolor = 'k', s=size, linewidth=0.4, alpha=alpha,zorder = 2)

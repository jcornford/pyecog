...
setup(
  ...
  download_url = 'https://github.com/jcornford/pyecog/tarball/0.1.23',
  keywords = ['iEEG', 'ECoG'], # arbitrary keywords
  install_requires=['numpy', 'pandas', 'scipy', 'matplotlib', 'seaborn','h5py','xlrd', 'bokeh', 'pyqtgraph', 'pomegranate']
)
...
setup(
  ...
  download_url = 'https://github.com/jcornford/pyecog/tarball/0.1.28',
  keywords = ['iEEG', 'ECoG'], # arbitrary keywords
  install_requires=['numpy','scikit-learn', 'pandas', 'scipy', 'matplotlib', 'seaborn','h5py','xlrd', 'bokeh', 'pyqtgraph', 'pomegranate']
)
...
setup(
  ...
  download_url = 'https://github.com/jcornford/pyecog/tarball/0.1.4', # I'll explain this in a second
  keywords = ['iEEG', 'ECoG'], # arbitrary keywords
  install_requires=['numpy', 'pandas', 'scipy', 'matplotlib', 'seaborn','h5py','xlrd']
)
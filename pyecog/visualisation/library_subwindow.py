...
class Ui_LibraryManagement(object):
    def setupUi(self, LibraryManagement):
        ...
        self.gridLayout_2.addWidget(self.line_3, 11, 0, 1, 5)
        ...
        self.gridLayout_2.addWidget(self.overwrite_box, 10, 0, 1, 5)
        ...
        self.gridLayout_2.addWidget(self.progressBar_label_above2, 12, 2, 1, 1)
    ...
    def retranslateUi(self, LibraryManagement):
        ...
        self.label_7.setText(_translate("LibraryManagement", "Warning, quite slow! Labels added automatically."))

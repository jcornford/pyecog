...
class Ui_convert_ndf_to_h5(object):
    ...
    def retranslateUi(self, convert_ndf_to_h5):
        ...
        self.logpath_dsplay.setText(_translate("convert_ndf_to_h5", "Path to Logfile:", None))
